function main() {
  ...
  function drawScene() {
    ...
    // move the origin of the matrix -50 -75 center for now
    const moveOriginMatrix = m4.translation(0, 0);

    // matrix math
    const aspect = canvas.clientWidth / canvas.clientHeight; 
    const zNear = 1;
    const xFar = 2000;   
    let matrix = m4.perspective(fieldOfViewRadians, aspect, zNear, xFar);
